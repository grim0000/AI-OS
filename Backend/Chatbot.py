...
def process_feedback(feedback: str, context: str = "", content_type: str = "general"):
    """Process user feedback for reinforcement learning"""
    try:
        from Backend.ReinforcementLearningSystem import rl_system
        return rl_system.process_feedback(feedback, context, content_type)
    except ImportError:
        print("Warning: Reinforcement Learning System not available for feedback processing")
        return {}
