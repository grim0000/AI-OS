...
def initialize_chrome_driver():
    try:
        # Force webdriver-manager to download the latest compatible version
...
def SpeechRecognition():
    # Initialize ChromeDriver only when needed
    driver = initialize_chrome_driver()
    if driver is None:
        print("Failed to initialize ChromeDriver. Speech recognition unavailable.")
        return None
