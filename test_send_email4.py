...
Tests sending an email with the snacks subject
"""
...
def test_send_email():
    ...
    try:
        ...
        # Test the exact command you want to use (fixed "subect" to "subject")
        test_command = "send email to sunillal360@gmail.com with subject 'snacks' saying 'get lays n juice test'"
